...
export default function ProductUpload({ farmerId, categories }) {
  ...
  // Format categories for SelectInput
  ...
  return (
    <form
      ...
      className="w-full max-w-4xl p-6 bg-gray-900 border border-gray-700 rounded-lg shadow mx-auto my-4"
    >
      <h2 className="text-2xl font-semibold mb-6 text-white">Upload New Product</h2>

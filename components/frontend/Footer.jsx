    ...
    <section className="py-10 bg-gray-50 sm:pt-16 lg:pt-24">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          ...
          {/* Company Links */}
          <div>
            <p className="text-sm font-semibold tracking-widest uppercase mb-6 text-gray-900">Company</p>
            <ul className="space-y-4">
              <li>
                <Link href="/about" className="text-base text-gray-800 hover:text-blue-600 focus:text-blue-600 transition-colors">
                  About
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link href="/customer-support" className="text-base text-gray-800 hover:text-blue-600 focus:text-blue-600 transition-colors">
                  Customer Support
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-base text-gray-800 hover:text-blue-600 focus:text-blue-600 transition-colors">
                  Terms & Conditions
                </Link>
              </li>
              <li>
                <Link href="/privacy-policy" className="text-base text-gray-800 hover:text-blue-600 focus:text-blue-600 transition-colors">
                  Privacy Policy
                </Link>
              </li>
            </ul>

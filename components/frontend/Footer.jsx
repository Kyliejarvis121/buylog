    ...
    <section className="py-10 bg-gray-50 sm:pt-16 lg:pt-24">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          ...
          {/* Social Icons */}
          <div>
            <p className="text-sm font-semibold tracking-widest uppercase mb-6">Follow Us</p>
          ...
          {/* Company Links */}
          <div>
            <p className="text-sm font-semibold tracking-widest uppercase mb-6">Company</p>
            <ul className="space-y-4">
              <li>
                <Link href="/about" className="text-base transition-colors duration-200 hover:text-blue-600 focus:text-blue-600">
                  About
                </Link>
              </li>
            </ul>
          ...
          {/* Help Links */}
          <div>
            <p className="text-sm font-semibold tracking-widest uppercase mb-6">Help</p>
            <ul className="space-y-4">
              <li>
                <Link href="/support" className="text-base transition-colors duration-200 hover:text-blue-600 focus:text-blue-600">
                  Customer Support
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-base transition-colors duration-200 hover:text-blue-600 focus:text-blue-600">
                  Terms & Conditions
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="text-base transition-colors duration-200 hover:text-blue-600 focus:text-blue-600">
                  Privacy Policy
                </Link>
              </li>
            </ul>
